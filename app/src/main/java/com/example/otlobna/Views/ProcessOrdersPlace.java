 ...
 */
public class ProcessOrdersPlace extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_process_orders_place, container, false);
    ...
    private void SetProcessOrdersInRecyclerView()
    {
        ...
        Call<ResponseBody> call = service.ProcessOrderPlace(Id);
