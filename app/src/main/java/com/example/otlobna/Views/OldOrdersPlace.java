 ...
 */
public class OldOrdersPlace extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_old_orders_place, container, false);
    ...
    private void SetEndOrdersInRecyclerView() {
        ...
        Call<ResponseBody> call = service.EndOrderPlace(Id);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (generalResponse.getError() == 0) {
                        ...
                        placeOrder = new PlaceOrder(getActivity(), Orders, "انهاء");
                        ...
                        placeOrder.setOnItemClickListener(new PlaceOrder.OnItemClickListener() {
                            ...
                            public void onEditClick(int position) {
                                // No Any Editing in the finish order ;))
                            }
