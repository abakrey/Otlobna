...
public class ProcessOrdersDelivery extends Fragment {
    private RecyclerView recyclerView ;
    private ArrayList<Order> Orders ;
    private View view ;
    private DeliveryOrder deliveryOrder ;

    public ProcessOrdersDelivery() {
        // Required empty public constructor
    }
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                            Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.fragment_process_orders_delivery, container, false);
        ...
        {
            SetProcessOrdersInRecyclerView();
        }
        else
        {
    ...
    private void SetProcessOrdersInRecyclerView()
    {
        ApiInterface service = ApiClient.getClient().create(ApiInterface.class);
        int ID = Integer.parseInt(Preferance.getID(getActivity()));
        Call<ResponseBody> call = service.ProcessOrderDelivery(ID);
    ...
    private void ShowDialogStatus( final int ID)
    {
        ...
        StatusTwo.setVisibility(View.INVISIBLE);
        Done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (StatusThree.isChecked())
                {
                    ProcessOfUpdateType(ID ,"انهاء");
                    dialog.dismiss();
                    deliveryOrder.notifyDataSetChanged();
                    SetProcessOrdersInRecyclerView();
                }
                else if (StatusTwo.isChecked())
                {
                    dialog.dismiss();
                }
                else
